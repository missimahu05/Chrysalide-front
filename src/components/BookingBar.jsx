        ...
        <div className="bg-white shadow-lg rounded-4 p-3 p-md-4 border-2" style={{ borderLeft: '5px solid #25854C', borderTop: '2px solid #CFA34C' }}>
          <form onSubmit={handleSubmit} className="row g-2 g-md-3 align-items-end">
            ...
            <div className="col-12 col-lg-2 mt-2 mt-lg-0">
              <button type="submit" className="btn btn-primary w-100 py-2.5 text-uppercase font-weight-bold shadow rounded-3 fs-6">
                <i className="fa fa-search me-2 d-lg-none"></i>Rechercher
              </button>
            </div>
          </form>
        </div>
