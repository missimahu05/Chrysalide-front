...
export default function CTAFinalSection({ onOpenBooking }) {
  return (
    <section 
      className="container-fluid py-5 text-white min-vh-100 d-flex align-items-center position-relative overflow-hidden" 
      id="cta-final"
      style={{ 
      ...
      <div className="container py-4 text-center position-relative" style={{ zIndex: 2 }}>
        <div className="row justify-content-center">
          <div className="col-lg-10">
            ...
            <span className="badge px-3 py-2 text-uppercase font-weight-bold mb-3 shadow-sm" style={{ backgroundColor: '#CFA34C', color: '#000', letterSpacing: '1.5px', fontSize: '0.8rem' }}>
              Offre Spéciale & Réservation Directe
            </span>

            <h1 className="display-4 font-weight-bold text-white mb-4 leading-tight">
            ...
            <p className="fs-5 mb-5 leading-relaxed" style={{ maxWidth: '820px', margin: '0 auto', color: '#E2E8F0' }}>
            ...
            <div className="d-flex flex-column flex-sm-row align-items-center justify-content-center gap-3 mb-5">
              <button 
                ...
                className="btn btn-lg btn-warning text-dark font-weight-bold text-uppercase px-5 py-3 shadow-lg"
                style={{ backgroundColor: '#CFA34C', borderColor: '#CFA34C', borderRadius: '50px', fontSize: '1rem' }}
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="btn btn-lg btn-outline-light font-weight-bold text-uppercase px-5 py-3 shadow-sm"
                style={{ borderRadius: '50px', fontSize: '1rem', color: '#FFFFFF', borderColor: 'rgba(255, 255, 255, 0.4)' }}
              >
            ...
            {/* Feature Pills */}
            <div className="d-flex flex-wrap justify-content-center gap-3" style={{ fontSize: '0.9rem' }}>
